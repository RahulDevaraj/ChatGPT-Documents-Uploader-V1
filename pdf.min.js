    ...
    var __webpack_modules__ = [
        ...
        (e, t, n) => {
          ...
          t.addLinkAttributes = function addLinkAttributes(
            e,
            { url: t, target: n, rel: s, enabled: a = !0 } = {}
          ) {
            (0, r.assert)(
              t && 'string' == typeof t,
          ...
          t.getXfaPageViewport = function getXfaPageViewport(
            ...
            const { width: r, height: s } = e.attributes.style,
          ...
          t.PDFDateString = class PDFDateString {
            static toDateObject(e) {
              ...
              return new Date(Date.UTC(n, s, a, i, l, c));
            }
          };
        },
        (e, t, n) => {
          ...
          t.createObjectURL = function createObjectURL(e, t = '', n = !1) {
          ...
          t.removeNullCharacters = function removeNullCharacters(e, t = !1) {
            if ('string' != typeof e) {
          ...
          t.stringToPDFString = function stringToPDFString(e) {
            ...
            if ('þ' === e[0] && 'ÿ' === e[1])
              ...
              for (let r = 0; r < t; ++r) {
                ...
                n.push(t ? String.fromCharCode(t) : e.charAt(r));
              }
            return n.join('');
          };
          ...
          class Util {
            ...
            static getAxialAlignedBoundingBox(e, t) {
              ...
              return [
                Math.min(n[0], r[0], s[0], a[0]),
                Math.min(n[1], r[1], s[1], a[1]),
                Math.max(n[0], r[0], s[0], a[0]),
                Math.max(n[1], r[1], s[1], a[1]),
              ];
            }
            ...
            static bezierBoundingBox(e, t, n, r, s, a, i, o) {
              const l = [],
                c = [[], []];
              let h, d, u, p, f, g, m, _;
              for (let c = 0; c < 2; ++c) {
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(e) {
            ...
            a.promise
              .then(function () {
                ...
                const e = _fetchDocument(a, r, s, i),
          ...
          class PDFPageProxy {
            ...
            render({
              ...
              const h = this._transport.getRenderingIntent(n, r);
              this.pendingCleanup = !1;
            ...
            getOperatorList({
              ...
              let r,
                s = this._intentStates.get(n.cacheKey);
              if (!s) {
            ...
            getTextContent(e = {}) {
              ...
              return new Promise(function (e, n) {
                ...
                !(function pump() {
                  r.read().then(function ({ value: t, done: n }) {
                    if (n) e(s);
                    else {
              ...
              const n = {
                data: (function cloneValue(e) {
                  if (globalThis.structuredClone)
                    return globalThis.structuredClone(e, t);
                  const n = new WeakMap();
                  return (function fallbackCloneValue(e) {
                    if (
                      'function' == typeof e ||
                      'symbol' == typeof e ||
                      e instanceof URL
                    ...
                    if (e instanceof Map) {
                      s = new Map();
                      n.set(e, s);
                      for (const [t, n] of e) s.set(t, fallbackCloneValue(n));
                      return s;
                    }
                    if (e instanceof Set) {
                      s = new Set();
                      n.set(e, s);
                      for (const t of e) s.add(fallbackCloneValue(t));
                      return s;
                    }
                    s = Array.isArray(e) ? [] : Object.create(null);
                    n.set(e, s);
                    for (const t in e) {
                      let n,
                        r = e;
                      for (; !(n = Object.getOwnPropertyDescriptor(r, t)); )
                        r = Object.getPrototypeOf(r);
                      void 0 !== n.value &&
                        ('function' != typeof n.value ||
                          e.hasOwnProperty?.(t)) &&
                        (s[t] = fallbackCloneValue(n.value));
                    }
                    return s;
                  })(e);
                })(e),
            ...
            getRenderingIntent(e, t = _util.AnnotationMode.ENABLE, n = !1) {
              ...
              switch (t) {
                ...
                case _util.AnnotationMode.ENABLE_STORAGE:
                  ...
                  s = this.annotationStorage.lastModified;
                  break;
                default:
                  (0, _util.warn)(
              ...
              n && (r += _util.RenderingIntentFlag.OPLIST);
              return { renderingIntent: r, cacheKey: `${r}_${s}` };
            }
            destroy() {
                ...
                if (!this.destroyed && !this.commonObjs.has(t))
                  switch (n) {
                    case 'Font':
                      ...
                      const i = new _font_loader.FontFaceObject(r, {
                      ...
                      this.fontLoader
                        ...
                        .finally(() => {
                          !s.fontExtraProperties && i.data && (i.data = null);
                ...
                if (!s.objs.has(e))
                  switch (n) {
                    case 'Image':
                      s.objs.resolve(e, r);
                      const t = 8e6;
                      r?.data?.length > t && (s.cleanupAfterRender = !0);
                      break;
                    case 'Pattern':
                      s.objs.resolve(e, r);
                      break;
        ...
        (e, t, n) => {
              ...
              if (this.isFontLoadingAPISupported) {
                ...
                if (t) {
                  ...
                  try {
                    ...
                    (0, r.warn)(`Failed to load font '${t.family}': '${n}'.`);
                    e.disableFontFace = !0;
                    throw n;
                  }
                }
          ...
          t.FontLoader = s = class GenericFontLoader extends BaseFontLoader {
            ...
            _prepareFontLoadEvent(e, t, n) {
              ...
              this.insertRule(p);
              const f = [];
              for (const e of t) f.push(e.loadedName);
              f.push(c);
        ...
        (e, t, n) => {
            ...
            if (!e.mozCurrentTransform) {
              ...
              Object.defineProperty(e, 'mozCurrentTransformInverse', {
                get: function getCurrentTransformInverse() {
                  const [e, t, n, r, s, a] = this._transformMatrix,
                    i = e * r - t * n,
                    o = t * n - e * r;
                  return [
                    r / i,
              ...
              e.transform = function ctxTransform(t, n, r, s, a, i) {
                ...
                e._originalTransform(t, n, r, s, a, i);
              };
              e.setTransform = function ctxSetTransform(t, n, r, s, a, i) {
                this._transformMatrix = [t, n, r, s, a, i];
                e._originalSetTransform(t, n, r, s, a, i);
              };
          ...
          class CachedCanvases {
            ...
            getCanvas(e, t, n, r) {
              ...
              if (void 0 !== this.cache[e]) {
                s = this.cache[e];
                this.canvasFactory.reset(s, t, n);
                s.context.setTransform(1, 0, 0, 1, 0, 0);
              } else {
                s = this.canvasFactory.create(t, n);
                this.cache[e] = s;
              }
              r && addContextCurrentTransform(s.context);
              return s;
            }
            clear() {
          ...
          class CanvasExtraState {
            ...
            getPathBoundingBox(e = s.PathType.FILL, t = null) {
              ...
              if (e === s.PathType.STROKE) {
                ...
                const e = r.Util.singularValueDecompose2dScale(t),
                  s = (e[0] * this.lineWidth) / 2,
          ...
          function composeSMaskBackdrop(e, t, n, r) {
            const s = e.length;
            for (let a = 3; a < s; a += 4) {
              const s = e[a];
              if (0 === s) {
          ...
          function composeSMaskAlpha(e, t, n) {
            ...
            for (let s = 3; s < r; s += 4) {
              const r = n ? n[e[s]] : e[s];
              t[s] = (t[s] * r * 0.00392156862745098) | 0;
            }
          }
          function composeSMaskLuminosity(e, t, n) {
            const r = e.length;
            for (let s = 3; s < r; s += 4) {
              const r = 77 * e[s - 3] + 152 * e[s - 2] + 28 * e[s - 1];
              t[s] = n ? (t[s] * n[r >> 8]) >> 8 : (t[s] * r) >> 16;
            }
          }
          function composeSMask(e, t, n, r) {
            const s = r[0],
              a = r[1],
              i = r[2] - s,
              o = r[3] - a;
            if (0 !== i && 0 !== o) {
              !(function genericComposeSMask(e, t, n, r, s, a, i, o, l, c, h) {
                const d = !!a,
                  u = d ? a[0] : 0,
                  p = d ? a[1] : 0,
                  f = d ? a[2] : 0;
                ...
                for (let s = 0; s < r; s += m) {
                  const a = Math.min(m, r - s),
                    _ = e.getImageData(o - c, s + (l - h), n, a),
                    A = t.getImageData(o, s + l, n, a);
                  d && composeSMaskBackdrop(_.data, u, p, f);
                  g(_.data, A.data, i);
                  t.putImageData(A, o, s + l);
                }
              })(
                t.context,
                n,
          ...
          function getImageSmoothingEnabled(e, t) {
            const n = r.Util.singularValueDecompose2dScale(e);
            n[0] = Math.fround(n[0]);
            n[1] = Math.fround(n[1]);
            const s = Math.fround(
          ...
          class CanvasGraphics {
            ...
            executeOperatorList(e, t, n, s) {
              ...
              for (;;) {
                ...
                f = i[o];
                if (f !== r.OPS.dependency) this[f].apply(this, a[o]);
                else
                  for (const e of a[o]) {
            ...
            _scaleImage(e, t) {
              ...
              for (; (i > 2 && l > 1) || (o > 2 && c > 1); ) {
                ...
                s = this.cachedCanvases.getCanvas(h, t, n);
                a = s.context;
                a.clearRect(0, 0, t, n);
            ...
            _createMaskCanvas(e) {
              ...
              const d = r.Util.applyTransform([0, 0], h),
                ...
                f = Math.ceil(p[2] - p[0]),
                g = Math.ceil(p[3] - p[1]),
                m = this.cachedCanvases.getCanvas('fillCanvas', f, g, !0),
                _ = m.context,
                A = Math.min(d[0], u[0]),
                b = Math.min(d[1], u[1]);
              _.translate(-A, -b);
              ...
              _.fillStyle = o ? i.getPattern(t, this, S, s.PathType.FILL) : i;
              _.fillRect(0, 0, n, a);
              return {
                canvas: m.canvas,
            ...
            beginSMaskMode() {
              ...
              const e = this.ctx.canvas.width,
                ...
                r = this.cachedCanvases.getCanvas(n, e, t, !0);
              this.suspendedCtx = this.ctx;
              this.ctx = r.context;
              const s = this.ctx;
              s.setTransform.apply(s, this.suspendedCtx.mozCurrentTransform);
              ...
              !(function mirrorContextOperations(e, t) {
                ...
                e.transform = function ctxTransform(e, n, r, s, a, i) {
                  t.transform(e, n, r, s, a, i);
                  this.__originalTransform(e, n, r, s, a, i);
                };
                e.setTransform = function ctxSetTransform(e, n, r, s, a, i) {
                  t.setTransform(e, n, r, s, a, i);
                  this.__originalSetTransform(e, n, r, s, a, i);
                };
                e.resetTransform = function ctxResetTransform() {
                  t.resetTransform();
                ...
                e.bezierCurveTo = function (e, n, r, s, a, i) {
                  t.bezierCurveTo(e, n, r, s, a, i);
                  this.__originalBezierCurveTo(e, n, r, s, a, i);
                };
                e.rect = function (e, n, r, s) {
                  t.rect(e, n, r, s);
                  this.__originalRect(e, n, r, s);
                };
            ...
            transform(e, t, n, r, s, a) {
              this.ctx.transform(e, t, n, r, s, a);
              this._cachedGetSinglePixelWidth = null;
            }
            constructPath(e, t) {
              const n = this.ctx,
              ...
              for (let c = 0, h = 0, d = e.length; c < d; c++)
                switch (0 | e[c]) {
                  case r.OPS.rectangle:
                    ...
                    s.updatePathMinMax(n.mozCurrentTransform, o, l);
                    s.updatePathMinMax(n.mozCurrentTransform, d, u);
                    n.closePath();
                    break;
                  case r.OPS.moveTo:
                    o = t[h++];
            ...
            setFont(e, t) {
              ...
              s.fontMatrix = n.fontMatrix || r.FONT_IDENTITY_MATRIX;
            ...
            setTextMatrix(e, t, n, r, s, a) {
              this.current.textMatrix = [e, t, n, r, s, a];
            ...
            showText(e) {
              ...
              for (x = 0; x < u; ++x) {
                ...
                if (n.remeasure && w > 0) {
                  const e = ((1e3 * i.measureText(u).width) / a) * o;
                  if (w < e && this.isFontSubpixelAAEnabled) {
                    ...
                    i.scale(t, 1);
                    S /= t;
                  } else w !== e && (S += (((w - e) / 2e3) * a) / o);
                }
                if (this.contentVisible && (t.isInFont || n.missingFile))
                  if (_ && !b) i.fillText(u, S, C);
                  else {
                    this.paintChar(u, S, C, A, y);
                    if (b) {
                      const e = S + (a * b.offset.x) / o,
                        t = C - (a * b.offset.y) / o;
                      this.paintChar(b.fontChar, e, t, A, y);
                    }
                  }
                P = p ? w * m - d * h : w * m + d * h;
                v += P;
            ...
            showType3Text(e) {
              const t = this.ctx,
                ...
                c = n.wordSpacing,
                h = n.textHScale * i,
                d = n.fontMatrix || r.FONT_IDENTITY_MATRIX,
                u = e.length;
              let p, f, g, m;
              if (
                !(n.textRenderingMode === r.TextRenderingMode.INVISIBLE) &&
                0 !== a
              ) {
                this._cachedGetSinglePixelWidth = null;
                t.save();
                ...
                for (p = 0; p < u; ++p) {
                  ...
                  g = r.Util.applyTransform([f.width, 0], d)[0] * a + i;
                  t.translate(g, 0);
                  n.x += g * h;
                }
                t.restore();
            ...
            setCharWidth(e, t) {}
            setCharWidthAndBounds(e, t, n, r, s, a) {
              this.ctx.rect(n, r, s - n, a - r);
              this.clip();
              this.endPath();
            }
            getColorN_Pattern(e) {
              ...
              if ('TilingPattern' === e[0]) {
                ...
                t = new s.TilingPattern(e, n, this.ctx, a, r);
            ...
            setStrokeRGBColor(e, t, n) {
              const s = r.Util.makeHexColor(e, t, n);
            ...
            shadingFill(e) {
              ...
              if (a) {
                const e = t.canvas,
                  ...
                  o = r.Util.applyTransform([0, s], a),
                  l = r.Util.applyTransform([n, 0], a),
                  c = r.Util.applyTransform([n, s], a),
            ...
            beginGroup(e) {
              ...
              const s = n.mozCurrentTransform;
              e.matrix && n.transform.apply(n, e.matrix);
              if (!e.bbox) throw new Error('Bounding box is required.');
              let a = r.Util.getAxialAlignedBoundingBox(
                e.bbox,
                n.mozCurrentTransform
              );
              const o = [0, 0, n.canvas.width, n.canvas.height];
              ...
              const g = this.cachedCanvases.getCanvas(f, h, d, !0),
                m = g.context;
              m.scale(1 / u, 1 / p);
              m.translate(-l, -c);
              m.transform.apply(m, s);
              if (e.smask)
              ...
              this.groupStack.push({ ctx: n, suspendedCtx: t });
              this.groupLevel++;
            }
            endGroup(e) {
              if (!this.contentVisible) return;
              this.groupLevel--;
              const t = this.ctx,
                { ctx: n, suspendedCtx: s } = this.groupStack.pop();
              this.ctx = n;
              this.ctx.imageSmoothingEnabled = !1;
              s && (this.suspendedCtx = s);
              if (e.smask) {
                ...
                const n = r.Util.getAxialAlignedBoundingBox(
            ...
            beginAnnotation(e, t, n, s, a) {
              ...
              if (Array.isArray(t) && 4 === t.length) {
                ...
                if (a && this.annotationCanvasMap) {
                  ...
                  t[2] = s;
                  t[3] = i;
                  const [a, o] = r.Util.singularValueDecompose2dScale(
                      this.ctx.mozCurrentTransform
                    ),
                    { viewportScale: l } = this,
                    c = Math.ceil(s * this.outputScaleX * l),
                  ...
                  d.style.width = `calc(${s}px * var(--viewport-scale-factor))`;
                    ...
                    ? (function compileType3Glyph(e) {
                        ...
                        return function (e) {
                          ...
                          for (let t = 0, n = m.length; t < n; t++) {
                            const n = m[t];
                            e.moveTo(n[0], n[1]);
                            for (let t = 2, r = n.length; t < r; t += 2)
                              e.lineTo(n[t], n[t + 1]);
                          }
                          e.fill();
                          e.beginPath();
            ...
            paintImageMaskXObjectRepeat(e, t, n = 0, s = 0, a, i) {
              if (!this.contentVisible) return;
              const o = this.ctx;
              o.save();
              const l = o.mozCurrentTransform;
              o.transform(t, n, s, a, 0, 0);
              const c = this._createMaskCanvas(e);
              o.setTransform(1, 0, 0, 1, 0, 0);
              for (let e = 0, h = i.length; e < h; e += 2) {
                const h = r.Util.transform(l, [t, n, s, a, i[e], i[e + 1]]),
            ...
            paintImageXObjectRepeat(e, t, n, s) {
              if (!this.contentVisible) return;
            ...
            paintInlineImageXObject(e) {
              ...
              if (
                ...
                const r = this.cachedCanvases.getCanvas('inlineImage', t, n);
                putBinaryImageData(r.context, e, this.current.transferMaps);
                s = r.canvas;
              }
              const a = this._scaleImage(s, r.mozCurrentTransformInverse);
              ...
              if (this.imageLayer) {
                const s = this.getCanvasPosition(0, -n);
                this.imageLayer.appendImage({
                  imgData: e,
                  left: s[0],
                  top: s[1],
                  width: t / r.mozCurrentTransformInverse[0],
                  height: n / r.mozCurrentTransformInverse[3],
                });
              }
              this.compose();
              this.restore();
            ...
            paintInlineImageXObjectGroup(e, t) {
              ...
              const n = this.ctx,
                r = e.width,
                s = e.height,
                a = this.cachedCanvases.getCanvas('inlineImage', r, s);
            ...
            getSinglePixelWidth() {
              if (null === this._cachedGetSinglePixelWidth) {
                const e = this.ctx.mozCurrentTransform,
                  ...
                  n = e[0] ** 2 + e[2] ** 2,
                  r = e[1] ** 2 + e[3] ** 2,
                  s = Math.sqrt(Math.max(n, r)) / t;
                n !== r && this._combinedScaleFactor * s > 1
                  ? (this._cachedGetSinglePixelWidth =
                      -this._combinedScaleFactor * s)
                  : t > Number.EPSILON
                  ? (this._cachedGetSinglePixelWidth = s)
        ...
        (e, t, n) => {
            ...
            getPattern(e, t, n, a) {
              ...
              if (a === s.STROKE || a === s.FILL) {
                const s = t.current.getClippedPathBoundingBox(
                  ...
                  o = Math.ceil(s[2] - s[0]) || 1,
                  l = Math.ceil(s[3] - s[1]) || 1,
                ...
                h.translate(-s[0], -s[1]);
                n = r.Util.transform(n, [1, 0, 0, 1, s[0], s[1]]);
          ...
          function drawTriangle(e, t, n, r, s, a, i, o) {
            const l = t.coords,
              c = t.colors,
              h = e.data,
              d = 4 * e.width;
          ...
          class MeshShadingPattern extends BaseShadingPattern {
            ...
            getPattern(e, t, n, a) {
              ...
              let i;
              if (a === s.SHADING)
                i = r.Util.singularValueDecompose2dScale(e.mozCurrentTransform);
              else {
                i = r.Util.singularValueDecompose2dScale(t.baseTransform);
                if (this.matrix) {
              ...
              const o = this._createMeshCanvas(
                i,
                a === s.SHADING ? null : this._background,
                t.cachedCanvases
              );
              if (a !== s.SHADING) {
          ...
          class TilingPattern {
            ...
            createPatternCanvas(e) {
              ...
              const h = n[0],
                ...
                u = n[2],
                p = n[3],
                f = r.Util.singularValueDecompose2dScale(this.matrix),
                g = r.Util.singularValueDecompose2dScale(this.baseTransform),
                m = [f[0] * g[0], f[1] * g[1]],
            ...
            setFillAndStrokeStyleToContext(e, t, n) {
              ...
              switch (t) {
                case a:
                  ...
                  break;
                case i:
                  const l = r.Util.makeHexColor(n[0], n[1], n[2]);
                  s.fillStyle = l;
                  s.strokeStyle = l;
                  o.fillColor = l;
                  o.strokeColor = l;
            ...
            getPattern(e, t, n, a) {
              let i = n;
              if (a !== s.SHADING) {
                i = r.Util.transform(i, t.baseTransform);
                this.matrix && (i = r.Util.transform(i, this.matrix));
              }
          ...
          t.MessageHandler = class MessageHandler {
            constructor(e, t, n) {
              ...
              this._onComObjOnMessage = (e) => {
                ...
                if (t.callback) {
                  ...
                  if (t.callback === s) n.resolve(t.data);
                  else {
                    if (t.callback !== a)
            ...
            _processStreamMessage(e) {
              const t = e.streamId,
                ...
                s = e.sourceName,
                a = this.comObj,
                f = this.streamControllers[t],
                g = this.streamSinks[t];
              switch (e.stream) {
                case p:
                  e.success
                    ? f.startCall.resolve()
                    : f.startCall.reject(wrapReason(e.reason));
                  break;
                case u:
                  e.success
                    ? f.pullCall.resolve()
                    : f.pullCall.reject(wrapReason(e.reason));
                  break;
                case d:
                  if (!g) {
                    a.postMessage({
                ...
                case l:
                  ...
                  f.isClosed = !0;
                  f.controller.close();
                  this._deleteStreamController(f, t);
                  break;
                case h:
                  (0, r.assert)(f, 'error should have stream controller');
                  f.controller.error(wrapReason(e.reason));
                  this._deleteStreamController(f, t);
                  break;
                case o:
                  e.success
                    ? f.cancelCall.resolve()
                    : f.cancelCall.reject(wrapReason(e.reason));
                  this._deleteStreamController(f, t);
                  break;
                case i:
                  if (!g) break;
                  new Promise(function (t) {
                    t(g.onCancel && g.onCancel(wrapReason(e.reason)));
                  }).then(
                    function () {
                      a.postMessage({
                        sourceName: n,
                  ...
                  g.sinkCapability.reject(wrapReason(e.reason));
                  g.isCancelled = !0;
        ...
        (e, t, n) => {
          ...
          t.Metadata = class Metadata {
            ...
            getAll() {
              return (0, r.objectFromMap)(this.#s);
            }
            has(e) {
              return this.#s.has(e);
            }
        ...
        (e, t, n) => {
          ...
          class AnnotationElement {
            constructor(
              ...
              r && (this.quadrilaterals = this._createQuadrilaterals(n));
            }
            _createContainer(e = !1) {
              ...
              if (t.hasOwnCanvas) {
                const e = s.transform.slice(),
                  [t, n] = r.Util.singularValueDecompose2dScale(e);
                i = Math.ceil(i * t);
                o = Math.ceil(o * n);
                l[0] *= t;
                l[1] *= n;
              ...
              } else a.style.transform = `matrix(${s.transform.join(',')})`;
            ...
            _getElementsByName(e, t = null) {
              ...
              if (this._fieldObjects) {
                ...
                if (s)
                  for (const { page: e, id: a, exportValues: i } of s) {
                    if (-1 === e) continue;
                    if (a === t) continue;
                    const s = 'string' == typeof i ? i : null,
                      o = document.getElementById(a);
                    !o || c.has(o)
                      ? n.push({ id: a, exportValue: s, domElement: o })
                      : (0, r.warn)(
              ...
              for (const r of document.getElementsByName(e)) {
                const { id: e, exportValue: s } = r;
                e !== t &&
                  c.has(r) &&
                  n.push({ id: e, exportValue: s, domElement: r });
              }
              return n;
            }
            static get platform() {
          ...
          class LinkAnnotationElement extends AnnotationElement {
            ...
            _bindResetFormAction(e, t) {
              ...
              if (this._fieldObjects)
                e.onclick = () => {
                  n && n();
                  const { fields: e, refs: r, include: s } = t,
                    a = [];
                  if (0 !== e.length || 0 !== r.length) {
                    ...
                    for (const e of Object.values(this._fieldObjects))
                      for (const n of e) t.has(n.id) === s && a.push(n);
                  } else
                    for (const e of Object.values(this._fieldObjects))
                      a.push(...e);
          ...
          class WidgetAnnotationElement extends AnnotationElement {
            ...
            _setEventListeners(e, t, n) {
              for (const [r, s] of t)
                ('Action' === s || this.data.actions?.[s]) &&
                  this._setEventListener(e, r, s, n);
            }
            ...
            _dispatchEventFromSandbox(e, t) {
              const setColor = (e, t, n) => {
                  const r = n.detail[e];
                  n.target.style[t] = i.ColorConverters[`${r[0]}_HTML`](
                    r.slice(1)
                  );
                },
                n = {
          ...
          class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                  ...
                  this.data.actions?.Keystroke &&
                    n.addEventListener('input', (e) => {
                      let n = -1,
                        r = -1;
                      a.beforeInputSelectionRange &&
                        ([n, r] = a.beforeInputSelectionRange);
                      this.linkService.eventBus?.dispatch(
                        'dispatcheventinsandbox',
                        {
                          source: this,
            ...
            _setTextStyle(e) {
              const t = ['left', 'center', 'right'],
                { fontSize: n, fontColor: s } = this.data.defaultAppearanceData,
                a = e.style;
              n && (a.fontSize = `${n}px`);
              a.color = r.Util.makeHexColor(s[0], s[1], s[2]);
            ...
            render() {
              ...
              s.addEventListener('change', (r) => {
                ...
                for (const r of this._getElementsByName(s, n)) {
                  const n = a && r.exportValue === t.exportValue;
          ...
          class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              s.addEventListener('change', (t) => {
                const { name: r, checked: s } = t.target;
          ...
          class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              n || (n = 9);
              const r = `calc(${n}px * var(--zoom-factor))`,
              ...
              s.addEventListener('resetform', (e) => {
                const t = this.data.defaultFieldValue;
                for (const e of s.options) e.selected = e.value === t;
              });
              ...
              if (this.enableScripting && this.hasJSActions) {
                s.addEventListener('updatefromsandbox', (n) => {
                  const r = {
                    value(n) {
                      const r = n.detail.value,
                        a = new Set(Array.isArray(r) ? r : [r]);
                      for (const e of s.options) e.selected = a.has(e.value);
          ...
          t.AnnotationLayer = class AnnotationLayer {
            static render(e) {
              ...
              for (const s of e.annotations)
                s &&
                  (s.annotationType !== r.AnnotationType.POPUP
                    ? t.push(s)
                    : n.push(s));
              n.length && t.push(...n);
              const i = e.div;
              ...
              this.#i(i, e.annotationCanvasMap);
            }
            static update(e) {
              const {
                  page: t,
                ...
                if (n)
                  for (const s of n)
                    if (e.hasOwnCanvas) {
                      ...
                      s.style.left = `${a}px`;
                      s.style.top = `${i}px`;
                      s.style.transformOrigin = `${-a}px ${-i}px`;
                      s.style.transform = h;
                    } else s.style.transform = l;
              }
              this.#i(i, a);
              i.hidden = !1;
            }
            ...
            static render(e) {
              ...
              for (; o.length > 0; ) {
                ...
                if (l.children && l.children.length > 0) o.push([l, -1, d]);
                  ...
                  const e = document.createTextNode(l.value);
                  s.XfaText.shouldBuildText(h) && c.push(e);
                  d.appendChild(e);
                }
              }
        ...
        (e, t, n) => {
          ...
          function expand(e) {
            ...
            for (let n = 0; n < s.length; n++) {
              ...
              if (0 === i.angle) {
                i.paddingLeft = t[n].left - s[n].left;
                i.paddingTop = t[n].top - s[n].top;
                i.paddingRight = s[n].right - t[n].right;
                i.paddingBottom = s[n].bottom - t[n].bottom;
          ...
          function expandBoundsLTR(e, t) {
            ...
            for (const e of t) {
              ...
              for (i = t; i <= a; i++) {
                ...
                let e = !1;
                for (o = t - 1; !e && o >= 0 && n[o].start >= s.y1; o--)
                  e = n[o].boundary === s;
                for (o = a + 1; !e && o < n.length && n[o].end <= s.y2; o++)
                  e = n[o].boundary === s;
          ...
          class TextLayerRenderTask {
            ...
            _layoutText(e) {
              ...
              if (0 !== t.canvasWidth && t.hasText) {
                const { fontSize: r, fontFamily: s } = e.style;
                if (
                  r !== this._layoutTextLastFontSize ||
                  s !== this._layoutTextLastFontFamily
                ) {
                  this._layoutTextCtx.font = `${r} ${s}`;
          ...
          t.SVGGraphics = i;
          {
            const e = {
              ...
              h = (function () {
                ...
                function writePngChunk(e, n, r, s) {
                  let a = s;
                  const i = n.length;
                  r[a] = (i >> 24) & 255;
                  r[a + 1] = (i >> 16) & 255;
                ...
                function encode(t, n, s, i) {
                  ...
                  if (n === r.ImageKind.GRAYSCALE_1BPP && i) {
                    f = 0;
                    for (let e = 0; e < l; e++) {
                      f++;
                  ...
                  return (0, r.createObjectURL)(b, 'image/png', s);
                }
            ...
            t.SVGGraphics = i = class {
              ...
              setTextMatrix(e, t, n, r, s, a) {
                ...
                i.textMatrix = i.lineMatrix = [e, t, n, r, s, a];
              ...
              showText(t) {
                ...
                const _ =
                  s.textRenderingMode & r.TextRenderingMode.FILL_STROKE_MASK;
                if (
                  ...
                  s.textRenderingMode === r.TextRenderingMode.ADD_TO_PATH
                ...
                s.txtElement.setAttributeNS(n, 'xml:space', 'preserve');
              ...
              setFont(e) {
                ...
                t.fontMatrix = n.fontMatrix || r.FONT_IDENTITY_MATRIX;
                let a = 'normal';
              ...
              setStrokeRGBColor(e, t, n) {
                this.current.strokeColor = r.Util.makeHexColor(e, t, n);
              }
              setFillAlpha(e) {
                this.current.fillAlpha = e;
              }
              setFillRGBColor(e, t, n) {
                this.current.fillColor = r.Util.makeHexColor(e, t, n);
              ...
              shadingFill(e) {
                const t = this.viewport.width,
                  ...
                  s = r.Util.inverseTransform(this.transformMatrix),
                  a = r.Util.applyTransform([0, 0], s),
                  i = r.Util.applyTransform([0, n], s),
                  o = r.Util.applyTransform([t, 0], s),
                  l = r.Util.applyTransform([t, n], s),
              ...
              _makeTilingPattern(e) {
                const t = e[1],
                  n = e[2],
                  s = e[3] || r.IDENTITY_MATRIX,
                  [a, i, o, l] = e[4],
                  c = e[5],
                  h = e[6],
                  d = e[7],
                  u = 'shading' + p++,
                  [f, g, m, _] = r.Util.normalizeRect([
                    ...r.Util.applyTransform([a, i], s),
                    ...r.Util.applyTransform([o, l], s),
                  ]),
                  [A, b] = r.Util.singularValueDecompose2dScale(s),
                  y = c * A,
                  S = h * b,
                  ...
                  case 'RadialAxial':
                    ...
                    switch (e[1]) {
                      case 'axial':
                        ...
                        s.setAttributeNS(null, 'x1', n[0]);
                        s.setAttributeNS(null, 'y1', n[1]);
                        s.setAttributeNS(null, 'x2', r[0]);
                        s.setAttributeNS(null, 'y2', r[1]);
                        break;
                      case 'radial':
                        const a = e[4],
                          i = e[5],
              ...
              paintInlineImageXObject(e, t) {
                ...
                i.setAttributeNS(o, 'xlink:href', s);
          ...
          class PDFNodeStreamFsRangeReader extends BaseRangeReader {
            constructor(e, t, n) {
              ...
              this._setReadableStream(
                a.createReadStream(r, { start: t, end: n - 1 })
              );
            }
          }
        },
        (e, t, n) => {
          ...
          t.validateRangeRequestCapabilities =
            function validateRangeRequestCapabilities({
              ...
              (0, r.assert)(n > 0, 'Range chunk size must be larger than zero');
        ...
        (e, t, n) => {
          ...
          class NetworkManager {
            ...
            onStateChange(e, t) {
              ...
              if (!n) return;
              const s = n.xhr;
              if (s.readyState >= 2 && n.onHeadersReceived) {
                n.onHeadersReceived();
              ...
              if (206 === a) {
                ...
                i ? n.onDone({ begin: 0, chunk: i }) : n.onError?.(s.status);
            }
            getRequestXhr(e) {
              ...
              fetch(
                ...
                .then((e) => {
                  if (!(0, s.validateResponseStatus)(e.status))
                    throw (0, s.createResponseStatusError)(e.status, n);
    ...
    (() => {
      ...
      if (i.isNodeJS) {
        ...
        const { PDFNetworkStream: e } = __w_pdfjs_require__(26),
          { PDFFetchStream: n } = __w_pdfjs_require__(27);
        (0, r.setPDFNetworkStreamFactory)((r) =>
          (0, t.isValidFetchUrl)(r.url) ? new n(r) : new e(r)
        );
      }
    })();
